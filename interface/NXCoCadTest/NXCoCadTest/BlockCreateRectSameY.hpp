...
//
//       Filename:  C:\Users\Administrator\Desktop\vs\menu_block\BlockCreateRectSameY.hpp
//
...
#ifndef BLOCKCREATERECTSAMEY_H_INCLUDED
#define BLOCKCREATERECTSAMEY_H_INCLUDED
...
class DllExport BlockCreateRectSameY
{
    // class members
public:
    static Session *theSession;
    static UI *theUI;
    BlockCreateRectSameY();
    ~BlockCreateRectSameY();
    int Show();
    ...
    // of these prototypes is provided in the BlockCreateRectSameY.cpp file. 
...
#endif //BLOCKCREATERECTSAMEY_H_INCLUDED
