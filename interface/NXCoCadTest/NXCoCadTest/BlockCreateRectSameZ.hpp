...
//
//       Filename:  C:\Users\Administrator\Desktop\vs\menu_block\BlockCreateRectSameZ.hpp
//
...
#ifndef BLOCKCREATERECTSAMEZ_H_INCLUDED
#define BLOCKCREATERECTSAMEZ_H_INCLUDED
...
class DllExport BlockCreateRectSameZ
{
    // class members
public:
    static Session *theSession;
    static UI *theUI;
    BlockCreateRectSameZ();
    ~BlockCreateRectSameZ();
    int Show();
    ...
    // of these prototypes is provided in the BlockCreateRectSameZ.cpp file. 
...
#endif //BLOCKCREATERECTSAMEZ_H_INCLUDED
