...
//
//       Filename:  C:\Users\Administrator\Desktop\vs\menu_block\BlockDrawCircle.cpp
//
//        This file was generated by the NX Block UI Styler
//        Created by: Administrator
//              Version: NX 8.5
//              Date: 04-21-2016  (Format: mm-dd-yyyy)
//              Time: 15:13 (Format: hh-mm)
//
//==============================================================================
...
//------------------------------------------------------------------------------
Session *(BlockDrawCircle::theSession) = NULL;
UI *(BlockDrawCircle::theUI) = NULL;
//------------------------------------------------------------------------------
// Constructor for NX Styler class
//------------------------------------------------------------------------------
BlockDrawCircle::BlockDrawCircle()
{
    try
    {
        ...
        theDialog->AddOkHandler(make_callback(this, &BlockDrawCircle::ok_cb));
        theDialog->AddUpdateHandler(make_callback(this, &BlockDrawCircle::update_cb));
        theDialog->AddInitializeHandler(make_callback(this, &BlockDrawCircle::initialize_cb));
        theDialog->AddDialogShownHandler(make_callback(this, &BlockDrawCircle::dialogShown_cb));
    }
    catch(exception& ex)
    {
...
int BlockDrawCircle::Show()
{
    ...
    {
        //---- Enter your exception handling code here -----
        BlockDrawCircle::theUI->NXMessageBox()->Show("Block Styler", NXOpen::NXMessageBox::DialogTypeError, ex.what());
    }
    return 0;
}
...
//------------------------------------------------------------------------------
void BlockDrawCircle::initialize_cb()
{
    try
    {
...
//------------------------------------------------------------------------------
void BlockDrawCircle::dialogShown_cb()
{
    try
    {
...
//------------------------------------------------------------------------------
int BlockDrawCircle::update_cb(NXOpen::BlockStyler::UIBlock* block)
{
    try
    {
        if(block == double0)
        ...
        //---------Enter your code here-----------
			...
			UI *nyUi = UI::GetUI();
			NXMessageBox *message = nyUi->NXMessageBox();
			double x = double0->Value();
...
//------------------------------------------------------------------------------
PropertyList* BlockDrawCircle::GetBlockProperties(const char *blockID)
{
